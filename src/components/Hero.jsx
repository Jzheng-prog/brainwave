                ...
                <div className="relative bg-n-8 rounded-[1rem]">
                    <div className="h-[1.4rem] bg-n-10 rounded-t-[0.9rem] "/>
                        <div className="aspect-[33/40] rounded-b-[0.9rem] overflow-hidden md:aspect-[688/490] lg:aspect-[1024/490]">
                            <img src={robot} alt="AI" className="w-full scale-[1.7] translate-y-[8%] md:scale-[1] md:-translate-y-[10%] lg:-translate-y-[23%]" height={490} width={1024}/>
                        </div>
                </div>
            </div>
            <div className="absolute -top-[54%] left-1/2 -translate-x-1/2 w-[234%] md:-top-[46%] md:w-[136%] lg:-top-[104%]">
